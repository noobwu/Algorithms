...
// ***********************************************************************
// <copyright file="Backoff.DecorrelatedJitterV2.cs" company="Noob.Algorithms">
...
namespace Noob.Algorithms.Polly.Contrib.WaitAndRetry
{
    ...
    /// Class Backoff.
    /// </summary>
    public partial class Backoff // .DecorrelatedJitterV2
    {
        /// <summary>
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">medianFirstRetryDelay - should be >= 0ms</exception>
